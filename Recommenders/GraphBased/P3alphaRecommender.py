...
class P3alphaRecommenderICM(P3alphaRecommender):
    """ RP3beta recommender ICM based """

    RECOMMENDER_NAME = "P3alphaRecommenderICM"

    def __init__(self, URM_train, ICM_LENGHT, ICM_TYPE, verbose = True):
        super(P3alphaRecommenderICM, self).__init__(URM_train, verbose = verbose)
    ...
    def __str__(self):
        return "RP3alpha(alpha={},  min_rating={}, topk={}, implicit={}, normalize_similarity={})".format(self.alpha,
