...
class P3alphaRecommender_stacked(BaseItemSimilarityMatrixRecommender):
    """ P3alpha recommender """
    ...
    def fit(self, topK=100, alpha=1., min_rating=0, implicit=False,mw = 0,mw_1=0, normalize_similarity=False):
